...
export default async function AboutSection() {
  ...
  return (
    <div className="w-full min-h-[1040px] bg-[url(/about-background.mobile.png)] sm:bg-[url(/about-background.tablet.png)] lg:bg-[url(/about-background.png)] bg-contain bg-top bg-no-repeat pt-[130px] lg:pt-[360px]">
